...
badd +1 simulace-nobatch.jl
badd +1318 term://~/Obsi/Prods/04-škola/_out/simulace-simsys//67749:/bin/bash
badd +67368 simulation.log
badd +3 qruna.sh
argglobal
%argdel
...
silent! normal! zE
let &fdl = &fdl
let s:l = 800 - ((10 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 800
...
setlocal fdn=20
setlocal fen
let s:l = 1358 - ((43 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 1358
